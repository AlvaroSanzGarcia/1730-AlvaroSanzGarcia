...
namespace Ex2C___Numeric_Type_Ranges
{
    public partial class FormNumericTypeRanges : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.int3 = checked(this.int1 + this.int2);   // Checked() tests for overflow. We use it because C# won't throw an exception when an integer overflows 
                int3TextBox.Text = int3.ToString();           //We don't need to convert the value to an Int because the + operator works with Ints
            }
